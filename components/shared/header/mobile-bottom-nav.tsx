          ...
          {tabs.map((tab) => {
            ...
            if (tab.action && "isCenter" in tab && tab.isCenter) {
              return (
                ...
                >
                  <div className="bg-brand-accent text-accent-foreground rounded-full h-14 w-14 flex items-center justify-center -mt-5 ring-4 ring-background shadow-card-glow hover:bg-brand-accent-dark transition-colors">
