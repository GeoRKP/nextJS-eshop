...
> = {
  pending: { color: "text-yellow-600 dark:text-yellow-400", bgColor: "bg-yellow-500/10 dark:bg-yellow-900/30", icon: Clock },
  confirmed: {
  ...
  processing: {
    ...
    bgColor: "bg-indigo-500/10 dark:bg-indigo-900/30",
    icon: Package,
  },
  shipped: { color: "text-purple-600 dark:text-purple-400", bgColor: "bg-purple-500/10 dark:bg-purple-900/30", icon: Truck },
  delivered: {
    color: "text-green-600 dark:text-green-400",
    bgColor: "bg-green-500/10 dark:bg-green-900/30",
    icon: MapPin,
  },
  cancelled: { color: "text-red-600 dark:text-red-400", bgColor: "bg-red-500/10 dark:bg-red-900/30", icon: XCircle },
  refund_requested: {
  ...
  refunded: {
    ...
    bgColor: "bg-gray-500/10 dark:bg-gray-900/30",
    icon: DollarSign,
  },
};
