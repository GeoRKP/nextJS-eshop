    ...
    <>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent>
            <RevenueChart data={salesTimeSeries} />
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3">
          ...
          <CardContent>
            <PaymentDonut data={revenueByPaymentMethod} />
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent>
            <CategoryPie data={salesByCategory} />
          </CardContent>
        </Card>
      </div>
    </>
...
function RevenueChart({ data }: { data: ChartsProps["salesTimeSeries"] }) {
...
function StatusDonut({ data }: { data: ChartsProps["ordersByStatus"] }) {
  if (data.length === 0) return <NoData />;
...
function PaymentDonut({ data }: { data: ChartsProps["revenueByPaymentMethod"] }) {
  if (data.length === 0) return <NoData />;
...
function TopProductsChart({ data }: { data: ChartsProps["topProducts"] }) {
  if (data.length === 0) return <NoData />;
...
function CategoryPie({ data }: { data: ChartsProps["salesByCategory"] }) {
  if (data.length === 0) return <NoData />;
